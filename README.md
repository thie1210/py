...
**macOS/Linux:**
```bash
curl -sSL https://raw.githubusercontent.com/thie1210/py/v0.1.3/install.sh | sh
export PATH="$HOME/.local/bin:$PATH"
```

**Windows (PowerShell):**
```powershell
Invoke-WebRequest -Uri https://raw.githubusercontent.com/thie1210/py/v0.1.3/install.ps1 -OutFile install.ps1
.\install.ps1
